...
class setting_config:
    ...
    work_dir = 'Results_Ablation Experiment/HLFF_vmunet_Eatch_Module/ISIC_2017/LP/' + network + '_Loss_BceDice' + '_' + datasets + '_' + datetime.now().strftime('%A_%d_%B_%Y_%Hh_%Mm_%Ss') + '/'
